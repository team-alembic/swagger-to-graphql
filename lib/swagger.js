...
exports.getAllEndPoints = exports.loadSchema = exports.getSchema = exports.setSchema = undefined;
...
var setSchema = exports.setSchema = function setSchema(schema) {
  if (!schema || !(0, _keys2.default)(schema).length) {
...
var replaceOddChars = function replaceOddChars(str) {
  return str && str.replace(/[^_a-zA-Z0-9]/g, "_");
};
